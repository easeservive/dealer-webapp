...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': 'd49y8yqixbnvsmg5',
        'USER': 'ulhdn9ehrcs79m23',
        'PASSWORD': 'mgrxq6kocy12f63d',
        'HOST': 'gk90usy5ik2otcvi.cbetxkdyhwsb.us-east-1.rds.amazonaws.com',   # Or an IP Address that your DB is hosted on
        'PORT': '3306',
    }
}
